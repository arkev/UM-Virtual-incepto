...
$subject = "$nombre descargo la plantilla de salud";
$subjectUsr = "$nombre te hacemos llegar tu plantilla para identificar nivel de actividad física";
$toUsr = $email;
$anio = 2015;
			...
			<table>
				<tr>
					<td>
						...
						<h3>Hola, $nombre</h3>
						<p class='lead'>Gracias por descargar el  template para identificar tu nivel de actividad física, desde aquí puedes acceder en cualquier momento y compartirlo con quien quieras.<br /><br />
...
Se estima que la inactividad física es la causa principal de aproximadamente un 21%-25% de los cánceres de mama y de colon, el 27% de los casos de diabetes y aproximadamente el 30% de la carga de cardiopatía isquémica.
                        ...
                        <td mc:edit='callout'>
							...
							<strong class='callout'>Al descargar el template para determinar tu nivel de actividad física podrás:</strong>
                           <ul class='callout'>
                               <li>Identificar tu nivel de actividad física</li>
                               <li>Medir tu nivel de actividad física</li>
                               <li>Reflexionar en tu rutina de vida diaria y plantear estrategias para mejorar tu actividad física. </li>
                           </ul>
                        </td>
                        </tr>
						</table><!-- /Callout Panel -->
