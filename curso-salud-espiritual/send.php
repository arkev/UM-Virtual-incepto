...
$subject = "$nombre entró al curso de salud espiritual";
$subjectUsr = "$nombre te hacemos llegar tu curso de salud espiritual";
$toUsr = $email;
$anio = 2015;
			...
			<table>
				<tr>
					<td>
						...
						<h3>Hola, $nombre</h3>
						<p class='lead'>Gracias por descargar el curso de Salud Espiritual, Jesús la gran esperanza,  para inscribirte al curso es necesario tomar en cuenta el siguiente proceso:<br><br>
                            1. Te llegará a tu correo una solicitud de validación de datos, para confirmar tu proceso de registro, por favor sigue las indicaciones del mensaje: <br>
                            <img src='images/captura-confirmar-correo.jpg' alt='captura de pantalla validación de datos'>
                            Asegurate de hacer click enal link para completar tu proceso de registro.<br><br>
                            2. Envía una confirmación del proceso anterior aquí:
                       </p>
                        </div>
