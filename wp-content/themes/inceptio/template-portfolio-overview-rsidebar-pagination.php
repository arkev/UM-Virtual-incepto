<?php
/**
 * Template Name: Portfolio Overview - Right Sidebar + Pagination
 */
get_header(); ?>
    ...
    <section id="content">
        <div class="container clearfix">
            <section id="main" class="three-fourths">
                ...
                <?php echo do_shortcode('[post_gallery pagination="true" type="portfolio" terms="' . $settings['terms'] . '" terms_order="' . $terms_order . '" count="'.$items_count.'" tca="'.$thumb_click_action.'" display_filters="false" columns="' . $settings['columns'] . '" display_meta="'.$display_meta.'" orderby="'.$order_by.'" order="'.$order.'"][/post_gallery]'); ?>
