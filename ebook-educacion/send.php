...
$subject = "$nombre descargo el eBook de educación";
$subjectUsr = "$nombre te hacemos llegar tu eBook gratuito sobre los retos que hay de enseñar a las nuevas generaciones";
$toUsr = $email;
$anio = 2015;
			...
			<table>
				<tr>
					<td>
						...
						<h3>Hola, $nombre</h3>
						<p class='lead'>Gracias por descargar el  e-book 'Retos y desafíos de la enseñanza a las nuevas generaciones', desde aquí puedes acceder al e-book en cualquier momento y compartirlo con quien quieras.<br><br>
                       ¿Sabias que a esta generación de niños y adolecentes se le conoce como la generación multipantallas?  ya que emplean los medios para un sin fin de actividades,  comunicar conocer, compartir divertirse y también consumir. 
Se trata, de una generación autodidacta. Por primera vez en la historia, dicen algunos autores, 'los niños no requieren de los mayores para aprender' ¿es así realmente?
                       </p>
                        </div>
                        ...
                        <td mc:edit='callout'>
							...
							<strong class='callout'>Al descargar el libro aprenderás a:</strong>
                           <ul class='callout'>
                               <li>Conocer y entender  las características de las nuevas generaciones.</li>
                               <li>Ideas prácticas para enseñar a los niños y adolescentes.</li>
                               <li>Estrategias para abordar el buen uso de la tecnología en la enseñanza y controlar el abuso de las pantallas.</li>
                           </ul>
                        </td>
                        </tr>
						</table><!-- /Callout Panel -->
